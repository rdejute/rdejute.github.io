# Research — AI-Generated Assets

Documents the provenance of AI-generated assets, as required by `ai-spec.md §5`
("Wherever an AI-generated image or the logo is used, leave a brief comment …
naming the tool used. This is a graded requirement.").

| Asset | File | AI tool used | Notes |
|---|---|---|---|
| Personal logo ("rd" monogram) | `src/assets/logo-rd.png` | **ChatGPT Images** | Used in the header (`Logo.jsx`). |
| Hero portrait | `src/assets/headshot.png` | **ChatGPT Images** | Image #1 on the Home page (`Hero.jsx`). |
